...
const STR = {
  en: {
    ...
    kpiIn: 'Input tokens (actual)', kpiInSub: 'incl {n} cached/replayed',
  ...
  zh: {
    ...
    kpiIn: '输入 token（实际）', kpiInSub: '含 {n} 缓存/重放',
  ...
  function Dashboard() {
    ...
    return h('div', { className: 'st-wrap' },
      ...
      h('div', { className: 'st-row' },
        ...
        h(Toggle, { k: 'compactAssist', label: T('toggleCompact', { n: fmtTok(cm.budgetTok || 120000) }), on: (cm.budgetTok || 0) > 0, onChange: refresh, t: T }),
        h('span', { style: { flex: 1 } }),
        h('button', {
          className: 'st-btn',
