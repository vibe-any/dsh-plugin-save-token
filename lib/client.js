  ...
  function Dashboard() {
    ...
    return h(
      ...
      h(
        ...
        h(Toggle, { k: "compactAssist", label: T("toggleCompact", { n: fmtTok(cm.watermarkTok || cm.budgetTok || 12e4) }), on: !!cm.assistOn, onChange: refresh, t: T }),
        h("span", { style: { flex: 1 } }),
        h("button", {
          className: "st-btn",
          onClick: async function() {
      ...
      h(
        ...
        h(
          ...
          h(
            "div",
            { className: "st-s st-dim", style: { marginTop: 2 } },
